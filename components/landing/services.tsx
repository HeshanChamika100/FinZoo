          ...
          <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {services.map((service, i) => (
              <div
                ...
                className={`group relative rounded-2xl border-2 ${service.border}
bg-gradient-to-br from-white/80 to-white/40
dark:from-white/10 dark:to-white/5
backdrop-blur-lg p-6 cursor-pointer
transition-shadow duration-300 hover:shadow-2xl`}
              ...
              >
                {/* Icon */}
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 rounded-xl ${service.bg} mb-4 duration-200 group-hover:shadow-xl`}
                >
                  <service.icon
                    className={`h-7 w-7 ${service.color} transition-all duration-200 group-hover:scale-110 group-hover:drop-shadow-lg`}
                  />
                </div>

                {/* Content */}
                <h3
                  className={`text-lg font-bold text-foreground mb-2 transition-all duration-200 group-hover:${service.color}`}
                >
                  {service.title}
                </h3>
