...
export function AddPetModal({ isOpen, onClose }: AddPetModalProps) {
  ...
  const resetForm = () => {
    setFormData({
      species: "", breed: "", age: "", price: "",
      price_type: "each" as "each" | "pair",
      image: "", images: [], video: "", videos: [],
      description: "", in_stock: true, is_visible: true, featured: false,
    })
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      ...
      >
        <DialogTitle className="sr-only">Add New Pet</DialogTitle>
          ...
          <div className="relative px-6 py-5 pr-14">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Fill in the details to add a pet to your inventory</p>
              </div>
            </div>
          </div>
          <button
        ...
        >
          <form onSubmit={handleSubmit} className="px-6 pb-11 pt-5 space-y-6">
              ...
              <div className="bg-muted/30 rounded-xl p-4 space-y-4 border border-border/50">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="species" className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                      Species *
                    </Label>
                    <Select
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="breed" className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                      Breed *
                    </Label>
                    <Input
                      id="breed"
